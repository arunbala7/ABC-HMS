...
<body
	style="background-image: url('CSS and JS/images/home.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
	...
	<div class="container">
		<div class="row">
			<div class="column col align-self-center">
				<div class="card">
					<img src="CSS and JS/images/Arun Balaji R.jpeg" alt="Arun Balaji R"
						style="width: 100%">
					<div class="container">
						...
						<p>
							<button class="button"
								onclick="location.href='https://www.linkedin.com/in/arunbalaultimate7/'">Contact</button>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="column col align-self-center">
				<div class="card">
					<img src="CSS and JS/images/Raja Thirumal G.jpeg"
						alt="Raja Thirumal G" style="width: 100%">
					<div class="container">
						...
						<p>
							<button class="button"
								onclick="location.href='https://www.linkedin.com/in/raja-thirumal-govindaraj-2566b1187/'">Contact</button>
						</p>
					</div>
				</div>
			</div>
		...
		<div class="row text-center justify-content-center">
			<div class="column ">
				<div class="card">
					<div class="container">
						<p class="title" style="color: black; font-size: 30px">Support
							Developers</p>
						<p>Nivetha R CT20172231274
						<p>
